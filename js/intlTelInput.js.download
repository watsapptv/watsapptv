   ...
   ********************/
        ...
        _generateMarkup: function() {
            ...
            if (!this.options.allowDropdown) {
                ...
                $('.flag-dropdown').css('cursor', 'default');
            }
        ...
        _initKeyListeners: function() {
            ...
            if (this.options.autoFormat) {
                this.telInput.on("paste blur" + this.ns, function(e) {
                    setTimeout(function() {
                        var formatted = that.telInput.val();
                        if (!formatted.startsWith("+")) {
                            formatted = "+" + formatted;
                        }
                        that._updateFlagFromNumber(formatted);
                        formatted = intlTelInputUtils.formatNumber(formatted, that.selectedCountryData.iso2, true);
                        that.telInput.val(formatted);
                    }, 100);
                });
